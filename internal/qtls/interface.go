...
func Client(conn net.Conn, config *qtls.Config) *Conn {
	return qtls.Client(conn, config)
}

// Server returns a new TLS server side connection.
func Server(conn net.Conn, config *qtls.Config) *Conn {
	return qtls.Server(conn, config)
}
